...
const isAuthenticated = async (req, res, next) => {
  ...
  const allowedRoutes = ['/send-otp']; // Add your specific routes here
// console.log(req.path);
  if (allowedRoutes.includes(req.path)) {
    // This route is allowed without authentication, proceed to the route handler
    return next();
  }

  // For other routes, continue with authentication
